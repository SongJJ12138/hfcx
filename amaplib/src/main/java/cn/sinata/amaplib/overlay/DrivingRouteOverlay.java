...
public class DrivingRouteOverlay extends RouteOverlay {
    ...
    private ArrayList<String> throughNameList;
    ...
    public DrivingRouteOverlay(Context context, AMap amap, DrivePath path,
        ...
        this(context, amap, path, start, end, null,null);
        mContext = context;
    }
    ...
    public DrivingRouteOverlay(Context context, AMap amap, DrivePath path,
                               LatLonPoint start, LatLonPoint end,
                               List<LatLonPoint> throughPointList,ArrayList<String> throughName) {
        super(context);
        this.mAMap = amap;
        this.drivePath = path;
