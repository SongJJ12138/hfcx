...
data class CarDetail(val pedestal:Int, val brandName:String, val company_id:Int, val carLineMoney:Double,
                     ...
                     val imgUrl:ArrayList<com.hfcx.user.beans.Image>, val rentingCarLabelList:ArrayList<CarLabel>)

data class RentRule(val value:String,val key:String)

data class CompanyInfo(val startTime:String,val distance:Double,val reserveNum:Int,val name:String,val endTime:String,val id:Int,val rentingNum:Int,val contactNumber:String,val lon: Double,val lat: Double,val address: String,val companyPictures:ArrayList<com.hfcx.user.beans.Image>)
