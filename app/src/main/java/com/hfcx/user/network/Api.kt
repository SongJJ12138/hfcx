...
object Api {
    ...
    const val BASE_URL = "http://qc96505.com/k2keyun/" //外网地址
//    const val SEND_URL = "http://192.168.0.104:8080/YunYou/" //本地地址
    ...
    const val CUSTOMLINES="personaTailor/getOrderListByUserId/"//私人订制票务列表
    const val CANCEL_CUSTOM="personaTailor/deleteOrderById/"//删除私人订制订单
    const val REFUND_CUSTOM="/app/personaTailor/refundPersonOrder/"//删除私人订制订单
