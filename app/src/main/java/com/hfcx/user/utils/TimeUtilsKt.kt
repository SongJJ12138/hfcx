...
fun StringDate(): String? {
    ...
    mYear = java.lang.String.valueOf(c[Calendar.YEAR]) // 获取当前年份
    mMonth = java.lang.String.valueOf(c[Calendar.MONTH] + 1) // 获取当前月份
    mDay = java.lang.String.valueOf(c[Calendar.DAY_OF_MONTH]) // 获取当前月份的日期号码
    mWay = java.lang.String.valueOf(c[Calendar.DAY_OF_WEEK])
    if ("1" == mWay) {
        mWay = "7"
    } else if ("2" == mWay) {
        mWay = "1"
