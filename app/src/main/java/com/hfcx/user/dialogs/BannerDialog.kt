...
class BannerDialog : DialogFragment() {
    ...
    private val mBanners = ArrayList<com.hfcx.user.beans.Banner>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mRecyclerView.adapter = object : BaseRecyclerAdapter<Banner>(mBanners, R.layout.item_banner) {
            override fun onBind(holder: ViewHolder, position: Int, data: com.hfcx.user.beans.Banner) {
        ...
        val t = if (arguments != null && arguments!!.containsKey("data")) {
            arguments!!.getParcelableArrayList<com.hfcx.user.beans.Banner>("data")
        } else {
            ArrayList()
        }
        mBanners.addAll(t)
