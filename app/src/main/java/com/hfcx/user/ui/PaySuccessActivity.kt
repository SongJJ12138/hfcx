...
//            title = "完成提交"
//            tv_msg.text = "提交成功"
//            tv_tip_1.text = SpanBuilder("※ 商家会及时与您联系，了解你的详细包车需求以及交流实际包车费用").color(this, 0, 1, R.color.darkorange).build()
//            tv_tip_2.text = SpanBuilder("※ 与商家商议好价格后，您需支付一定的预订金，若您因其他原因需要取消包车，预订金不予退还").color(this, 0, 1, R.color.darkorange).build()
//            val phone = SPUtils.instance().getString(Const.SERVICE_PHONE)
//            tv_hot_line.text = SpanBuilder("※ 若有任何疑问请拨打客服热线：$phone")
//                    .color(this, 0, 1, R.color.darkorange)
//                    .color(this, 16, 16+phone.length, R.color.black_text).build()
//        } else {
//            title = "完成支付"
//            tv_tip_1.text = SpanBuilder("※ 请根据预约时间到商家门店租车").color(this, 0, 1, R.color.darkorange).build()
//            tv_tip_2.text = SpanBuilder("※ 到店时请用身份证+驾驶证+驾驶员国内信用卡作为取车凭证").color(this, 0, 1, R.color.darkorange).build()
//            val phone = SPUtils.instance().getString(Const.SERVICE_PHONE)
//            tv_hot_line.text = SpanBuilder("※ 若有任何疑问请拨打客服热线：$phone")
//                    .color(this, 0, 1, R.color.darkorange)
//                    .color(this, 16, 16+phone.length, R.color.black_text).build()
